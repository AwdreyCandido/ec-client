...
const HeroSection = () => {
  return (
    <section className="flex flex-col md:flex-row h-auto md:h-screen w-full px-8 md:pt-0 sm:px-8 md:px-20 py-20 md:py-36 bg-linear-to-br from-secondary-light from-40% to-secondary rounded-tl-[5rem] md:rounded-tl-[15rem] rounded-br-[5rem] md:rounded-br-[15rem] shadow-sm">
