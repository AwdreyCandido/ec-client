...
const NavBar: React.FC = () => {
  ...
  return (
    <header className="w-[90vw] md:w-[80vw] bg-white py-8 px-8 flex justify-between items-center absolute top-10 z-50 backdrop-blur-md left-[50%] -translate-x-[50%] rounded-4xl shadow-md">
      <h1 className="text-2xl font-extrabold text-gray-900 tracking-wide">
        Ecommerce
      </h1>

      <nav className="flex items-center gap-20">
        <div className="flex text-button gap-6 translate-x-[4rem] sm:translate-x-0 text-gray-700 font-medium">
          <a href="/" className="hover:text-secondary transition">
            Início
          </a>
          <a href="/F#stores" className="hover:text-secondary transition">
            Lojas
          </a>
        </div>
